...
public class ClickConfig {
    ...
    static {
        ...
        builder.comment("Click Mod Configuration").push("general");

        builder.comment("Entity Stats").push("stats");
        ...
        SPAWN_CHANCE = builder
                .comment("Chance (0.0 to 1.0) for a click sound to play when lighting conditions are met (night, cave, thick tree coverage, etc.). Default: 0.025")
